/*
	SubmissionId	:	3464427
	ContestId	:	289
	Index	:	D
	ProblemName	:	Polo the Penguin and Houses 
	ProblemTags	:	['brute force', 'combinatorics', 'dfs and similar', 'math']
...
int main()
{
	...
	int n, k;
	cin >> n >> k;
	ll ans = ((ll)(power(k, k - 1) % M) * (ll)(power(n - k, n - k) % M)) % M;
	cout << ans << endl;
	return 0;
}
