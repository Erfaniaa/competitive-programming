/*
	SubmissionId	:	3284926
	ContestId	:	281
	Index	:	B
	ProblemName	:	Nearest Fraction
	ProblemTags	:	['brute force', 'implementation', 'two pointers']
...
int main()
{
	...
	{*/
		...
		{
			int z = norm(a * y / b);
			double dif = abs((double)(a * y - b * z) / (b * y));
			if (dif < mn)
			{
				mn = dif;
				ans = z;
