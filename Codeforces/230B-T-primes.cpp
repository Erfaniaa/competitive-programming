/*
	SubmissionId	:	2277908
	ContestId	:	230
	Index	:	B
	ProblemName	:	T-primes
	ProblemTags	:	['binary search', 'implementation', 'math', 'number theory']
...
#define maxn (ll)((ll)1000 * (ll)1000 * (ll)1000 * (ll)1000)
